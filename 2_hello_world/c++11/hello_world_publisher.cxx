...
void run_example(unsigned int domain_id, unsigned int sample_count)
{
    ...
    for (unsigned int count = 0;
        ...
        sample.device_id(45723568);
        //sample.communication_type(CommunicationType("RS422"));
        sample.device_name("test_device_name");
        sample.device_number(1);
        sample.device_properties("test_device_properties");
        sample.upper_linked_device_id(9999999);
        sample.lower_linked_device_id(1111111);
